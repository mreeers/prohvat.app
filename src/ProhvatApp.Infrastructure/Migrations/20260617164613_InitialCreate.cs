        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartPoint = table.Column<Point>(type: "geography(Point, 4326)", nullable: false),
                    GpxTrackPath = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rides_VehicleCategories_TargetCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentMetricsValue = table.Column<decimal>(type: "numeric", nullable: false),
                    TechnicalConfigJson = table.Column<string>(type: "jsonb", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RideMembers", x => new { x.RideId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rides_StartPoint",
                table: "Rides",
                column: "StartPoint")
                .Annotation("Npgsql:IndexMethod", "gist");

            migrationBuilder.CreateIndex(
                name: "IX_Rides_TargetCategoryId",
                table: "Rides",
